...
public class TablaBoletosLeidosAdapter extends BaseAdapter {
     ...
     */
    public TablaBoletosLeidosAdapter(ArrayList<String> listaBoletosLeidos, Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.tabla_boleto_leido, null);
        ...
        for (int i = 0; i < lista_boletosLeidos.size(); i++) {
            ...
            String[] dataBoletoLeido = lista_boletosLeidos.get(i).split("ƒ");
