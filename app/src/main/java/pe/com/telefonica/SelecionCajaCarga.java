...
public class SelecionCajaCarga extends Fragment {
    private Gson gson;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.selecion_caja_carga,parent,false );
    }
    ...
    public void onViewCreated(View view ,Bundle  savedInstanceState)
    {
        ...
        btn_conanf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if (CajaSelec.equals("")) {
                    Toast.makeText(getActivity(),"INGRESE UNA CAJA",Toast.LENGTH_LONG).show();
                }
                else if(!CajaSelec.equals("")){
                    final RequestQueue queue = Volley.newRequestQueue(getContext());
                    Toast.makeText(getActivity(),"SELECCIONASTE LA CAJA "+CajaSelec,Toast.LENGTH_LONG).show();
                    guardarDataMemoria("CodCaja",CajaSelec,getActivity());
...
//        final Spinner_model so = (Spinner_model)spin_serie.getSelectedItem();
        String ws_seriebus = getString(R.string.ws_ruta) + "TRCAJA_USUA/" + sharedPreferences.getString("CodUsuario", "nada")+'/'+ sharedPreferences.getString("CodAgencia", "nada");
                        ...
                        if (response.length()>=0)
                        {
                            ...
                            try{
                                for (int i = 0; i < response.length(); i++){
                                    ...
                                    lista_cajas.add(json.getString("CO_CAJA"));
                                }
